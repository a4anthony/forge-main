const CsvDataGateway = require("../gateways/CsvDataGateway");
...
const InfluxDataGateway = require("../gateways/InfluxDataGateway")
        ...
        if (!provider || !project) {
            ...
            switch (provider) {
                ...
                case "influx":
                    ...
                    req.dataGateway = new InfluxDataGateway(deviceModelFile,deviceFile);
                    break;
                case "csv":
                    {
